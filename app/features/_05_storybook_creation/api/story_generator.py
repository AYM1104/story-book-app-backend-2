...
async def supabase_select_theme(
    ...
    プラン制限チェックは validate_story_plan で自動的に実行されます。
    """
    
    # 処理時間計測開始
    start_time = time.time()
    print(f"=== テーマ選択＆物語生成処理開始 ===")
    ...
    try:
        ...
        user_id = plan_validation.user_id
        story_setting = plan_validation.story_setting
